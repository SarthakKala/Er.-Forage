...
export default function DifferentiatorsSection() {
  return (
    <section className="bg-[#050505]" style={{ padding: "96px 40px" }}>
      <p className="text-[11px] uppercase tracking-[0.08em] text-[#3ECF8E]">Why Er. Forge</p>
      <h2 className="mt-3 max-w-3xl text-[32px] font-medium tracking-[-1px] text-white/90 md:text-[40px]">
        Others help you solve problems.
      </h2>
      <p className="mt-2 text-[22px] font-medium md:text-[26px]" style={{ color: "#3ECF8E" }}>
        Er. Forge ensures you stop creating the same ones.
      </p>

      <div
        className="mt-10 overflow-hidden rounded-[12px]"
        ...
        {rows.map(([left, right]) => (
          ...
          >
            <div
              ...
              style={{ color: "rgba(255,255,255,0.35)", textDecoration: "line-through", textDecorationColor: "rgba(255,255,255,0.15)" }}
            >
              {left}
            </div>
